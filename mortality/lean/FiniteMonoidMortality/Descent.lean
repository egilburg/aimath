...
/-!
# Quantitative sandwich rank descent

The word-length recurrence retains both outside words: L ↦ 2L + D. Starting from a singular generator saves one descent step.
-/
