import SierpinskiFormal.SoficRationalSharpness
import SierpinskiFormal.UniformSoficRealization
...
theorem exists_rational_sharp_sofic_process (n : ℕ) (hn : 2 ≤ n) :
    ∃ (A : Type) (_ : Fintype A) (_ : MeasurableSpace A)
      ...
      MeasurePreserving digitShift μ μ ∧
  ...
  have hstat : MeasurePreserving digitShift μ μ := uniformSoficMeasure_stationary T h0 hsum
