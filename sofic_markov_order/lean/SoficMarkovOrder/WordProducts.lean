...
/-! # Word products and reachable columns

Products act on columns: the rightmost letter acts first. This small module
contains only the word-product and reachable-span definitions used by the
Hankel representation and sharpness proofs.
-/
